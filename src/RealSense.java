...
public class RealSense {
    ...
    private static void DisplayCameraFeed() {
        ...
        RealSense r_raw = new RealSense();
        DrawFrame r_df=new DrawFrame(rWidth, rHeight);
        JFrame rframe= new JFrame("Intel(R) RealSense(TM) SDK - Right Stream");
        rframe.addWindowListener(listener);
        rframe.setSize(rWidth, rHeight);
        rframe.add(r_df);
        rframe.setVisible(true);

        RealSense l_raw = new RealSense();
        DrawFrame l_df=new DrawFrame(lWidth, lHeight);
        JFrame lframe= new JFrame("Intel(R) RealSense(TM) SDK - Left Stream");
